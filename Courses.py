sde_course = [
    ['Data Structures and Algorithms by TakeUForward (DSA)', 'https://takeuforward.org/courses/data-structures-and-algorithms/'],
    ['Full Stack Web Development by FreeCodeCamp', 'https://www.freecodecamp.org/learn/'],
    ['Complete Data Structures & Algorithms Course by GeeksforGeeks', 'https://www.geeksforgeeks.org/data-structures-and-algorithms-course/'],
    ...
    ['Full Stack Web Development with React Specialization by Coursera', 'https://www.coursera.org/specializations/full-stack-react'],
    ['Data Structures and Algorithms in Python by Udemy', 'https://www.udemy.com/course/data-structures-and-algorithms-in-python/'],
    ['The Complete 2021 Web Development Bootcamp by Dr. Angela Yu', 'https://www.udemy.com/course/the-web-development-bootcamp/'],
    ...
    ['The Complete Node.js Developer Course (3rd Edition) by Udemy', 'https://www.udemy.com/course/the-complete-nodejs-developer-course-2/']
]
